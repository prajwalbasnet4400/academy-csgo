...
class ResolverTestCase(TestCase):
    ...
    profile_url_profiles = 'https://steamcommunity.com/profiles/76561198160555274/'
    ...
    profile_url_invalid = 'https://steamcommunity.com/poa/76561198160555274/'

    profile_vanity = 'theonionknight4400'
    profile_steamid64 = '76561198160555274'
    ...
    def test_identify_steamid_type(self):
        ...
        self.assertRaises(ValidationError,resolver.identify_steamid_type(self.profile_url_invalid))
